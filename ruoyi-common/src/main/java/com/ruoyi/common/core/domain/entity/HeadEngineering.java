 ...
 * @author KrityCat
 */
public class HeadEngineering extends BaseEntity {
...
//    @Excel(name = "订单号")
     ...
     * 审核结果
     */
    @Excel(name = "审核结果", readConverterExp = "0=通过,1=不通过")
    ...
    private List<DetailEngineering> details;
    ...
    public List<DetailEngineering> getDetails() {
        return details;
    }

    public void setDetails(List<DetailEngineering> details) {
