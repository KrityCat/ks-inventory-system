 ...
 */
@RestController
@RequestMapping("/inventory/historicalDocuments")
public class historicalDocumentsController extends BaseController {
     ...
     * 库存单据头表查询
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:head')")
    @GetMapping("/head")
     ...
     * 库存单据明细查询
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:detail')")
    @GetMapping("/detail")
     ...
     * 库存指定单据查询
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:SystematicReceipt')")
     ...
     * 删除库存单据
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:delete')")
     ...
     * 导入单据头表接口
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:importHeadData')")
     ...
     * 导入单据明细表接口
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:importDetailData')")
     ...
     * 库存单据头表导出
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:headReceiptExport')")
     ...
     * 库存单据明细导出
     */
    @PreAuthorize("@ss.hasPermi('inventory:historicalDocuments:detailReceiptExport')")
