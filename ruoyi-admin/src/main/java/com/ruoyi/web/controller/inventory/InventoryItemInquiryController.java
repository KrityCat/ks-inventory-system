 ...
 */
@RestController
@RequestMapping("/system/inventoryItemInquiry")
public class InventoryItemInquiryController extends BaseController {
     ...
     * 库存货品查询
     */
    @PreAuthorize("@ss.hasPermi('system:inventoryItemInquiry:list')")
    @GetMapping("/list")
     ...
     * 库存货品导出
     */
    @PreAuthorize("@ss.hasPermi('system:inventoryItemInquiry:export')")
