 ...
 */
@RestController
@RequestMapping("/system/inventoryOccurrenceDetails")
public class InventoryOccurrenceDetailsController extends BaseController {
     ...
     * 库存发生明细查询
     */
    @PreAuthorize("@ss.hasPermi('system:inventoryOccurrenceDetails:list')")
    @GetMapping("/list")
     ...
     * 库存发生明细导出
     */
    @PreAuthorize("@ss.hasPermi('system:inventoryOccurrenceDetails:export')")
