 ...
 */
@RestController
@RequestMapping("/inventory/reportOverflowProcessing")
public class ReportOverflowProcessingController extends BaseController {
     ...
     * 报溢指定单据查询
     */
    @PreAuthorize("@ss.hasPermi('inventory:reportOverflowProcessing:systematicReceipt')")
     ...
     * 保存报溢单据信息
     */
    @PreAuthorize("@ss.hasPermi('inventory:reportOverflowProcessing:save')")
    @Log(title = "保存报溢单据信息", businessType = BusinessType.INSERT)
    @PostMapping("/save")
     ...
     * 删除报溢单据
     */
    @PreAuthorize("@ss.hasPermi('inventory:reportOverflowProcessing:delete')")
    @Log(title = "删除报溢单据", businessType = BusinessType.DELETE)
    @PostMapping("/delete")
