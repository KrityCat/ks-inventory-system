<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">铠思商用进销存系统 v1.4.0</h1>
...
<img alt="采购单据制作" height="24%" src="./img/采购单据制作.png" width="24%"/>
<img alt="采购单据查询" height="24%" src="./img/采购单据查询.png" width="24%"/>
...
<img alt="打印模板查询" height="24%" src="./img/打印模板查询.png" width="24%"/>
<img alt="在线表格"    height="24%" src="./img/在线表格.png" width="24%"/>

## 内置主要功能

1. 采购管理：采购订单制作、采购单据制作、采购订单查询、采购单据查询
2. 销售管理：销售订单制作、销售单据制作、销售订单查询、销售单据查询
3. 库存管理：库存单据制作、报损单据制作、报溢单据制作、库存调拨单据制作、库存盘点单据制作、库存单据查询、库存发生汇总、库存发生明细、库存货品查询、库存挤压查询、配件查询
...
* 用于测试系统接口是否有报错，建议配合使用
* [铠思进销存系统的API自动化测试](https://gitee.com/KrityCat/APIAutomatedTestingToKS)
