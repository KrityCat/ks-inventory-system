        ...
        >
          ...
          <el-form-item label="单据类型" prop="receiptType">
            <el-radio-group class="form-item" v-model="form.receiptType">
              <el-radio-button label="7" :value="7">库存调拨</el-radio-button>
            </el-radio-group>
          </el-form-item>
          ...
          <el-affix class="tc mt16 footer" position="bottom" :offset="20">
            ...
            >
              <el-button
                ...
                round
                :disabled="printBtn"
                v-hasPermi="['inventory:inventoryTransferProcessing:delete']"
                ref="ref22"
                >删除单据</el-button
              >
            </el-tooltip>
...
<script setup name="inventoryTransfer">
...
async function addOrder() {
  ...
  router.push({ path: "/inventory/inventoryTransfer" });
}
/** 统计金额和成本 */
