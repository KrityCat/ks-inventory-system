    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        <el-form
          ...
          label-width="100px"
        >
          <el-form-item label="系统单号" prop="originalReceipt">
            <el-input
          ...
          <el-form-item>
            ...
            <el-button
              ...
              v-hasPermi="['system:sales:salesDetailQuery']"
              >明细查询</el-button
            >
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              icon="Download"
              @click="handleExport"
              v-hasPermi="['system:sales:salesHeadExport']"
              >导出</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              v-hasPermi="['system:sales:salesDetailExport']"
              >明细导出</el-button
            >
          </el-col>
          <right-toolbar
            ...
            <template #default="scope">
              <el-tooltip content="打印" placement="top">
                <el-button
                  ...
                  v-hasPermi="['system:sales:printOut']"
                ></el-button>
              </el-tooltip>
              <el-tooltip content="修改" placement="top">
                <el-button
                  ...
                  v-hasPermi="['system:sales:update']"
                ></el-button>
              </el-tooltip>
              <el-tooltip content="删除" placement="top">
                <el-button
                  ...
                  v-hasPermi="['system:sales:delete']"
                ></el-button>
              </el-tooltip>
            </template>
          </el-table-column>
...
function getList() {
  loading.value = true;
  listSalesOrder(proxy.addDateRange(queryParams.value, dateRange.value)).then(
    (response) => {
...
function handleDetailExport() {
  proxy.download(
    "system/sales/salesDetailExport",
    {
      ...queryParams.value,
    },
