    ...
    <el-row :gutter="10">
      <el-col :span="24" :xs="24">
        ...
        >
          ...
          <el-form-item label="单据类型" prop="receiptType">
            <el-radio-group class="form-item" v-model="form.receiptType">
              <el-radio-button label="3">销售出库</el-radio-button>
              <el-radio-button label="4" disabled>销售退库</el-radio-button>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="单据状态" prop="receiptStatus">
            ...
            >
              ...
              <el-option
                label="生效"
                :value="2"
                :disabled="['system:sales:takeEffectSalesOutbound']"
                >生效</el-option
              >
            </el-select>
          </el-form-item>
        ...
        <div>
          ...
          <div>
            <el-table :data="form.details" show-summary :summary-method="getSummaries">
              <el-table-column
                label="货品编号"
                align="center"
          ...
          <div class="tc mt16 footer">
            ...
            <el-button
              @click="submitForm"
              type="primary"
              v-hasPermi="['system:sales:saveSalesOutbound']"
              >保存</el-button
            >
          </div>
        </div>
...
import { getSalesOrder, saveSalesOutbound } from "@/api/sales/salesOutbound";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        invoiceDate: [
          { required: true, message: "出货日期不能为空", trigger: "blur" },
        ],
      },
      modalObj: {
        open: false,
  ...
  methods: {
      ...
      this.$refs["form"].validate((valid) => {
        ...
        const details = this.form.details.map((it) => {
          ...
          return {
            ...
            retrievalId: this.form.retrievalIds,
            warehouseId: this.form.retrievalIds,
        ...
        saveSalesOutbound(req).then((response) => {
          this.$modal.msgSuccess("销售出库单保存成功");
          this.cancel();
        });
      });
    },
    loadDetail(systematicReceipt) {
      getSalesOrder(systematicReceipt).then((response) => {
        ...
        const userId = response.data.userIds;
        ...
        this.form.retrievalIds = Number(response.data.retrievalIds);
